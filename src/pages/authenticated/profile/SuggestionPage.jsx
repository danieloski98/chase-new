...
import AppreciationPrompt from "@/pages/authenticated/profile/modals/AppreciationPrompt"
...
function SuggestionPage() {
  ...
  const handleSubmit = event => {
    ...
    let appreciation = <AppreciationPrompt />
              ...
              <div className="mb-4">
                <div className="flex items-center">
                  <input
                    ...
                    placeholder="Suggested feature title"
                    value={title}
