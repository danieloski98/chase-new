...
const MyNetwork = (props) => {
  ...
  const { results, isLoading, lastChildRef, refetch, data } = useInfinteScroller({url:activeTab === "Connects" ? '/user/get-users-connections/'+userId: '/user/friend-requests', pageNumber:page, setPageNumber:setPage})
