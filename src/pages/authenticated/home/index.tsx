...
import { HStack, Spinner, Textarea, VStack, AspectRatio } from '@chakra-ui/react'
    ...
    <PageWrapper toggleFileUploader={toggleFileUploader}>
      {() => (
          ...
          <HStack width='100%' height='200px' paddingLeft={['0px', '70px']} >
            <VStack width={['100%', '100%', '65%', '40%']} height='80%' paddingY='20px' bg='whitesmoke' borderRadius={20} paddingX='20px' alignItems='flex-start' shadow='md' >
          ...
          <VStack width='100%' flex={1} overflow='auto' paddingLeft={['0px', '70px']} paddingBottom='150px' alignItems='flex-start'>
            <VStack width={['100%',  '100%', '65%', '40%']} alignItems='flex-start'>
